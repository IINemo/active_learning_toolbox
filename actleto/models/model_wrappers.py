...
<meta content="src/active_learning/model_wrappers.py · master · Nemo / skoltech_cardiology" property="og:title">
...
<meta content="https://gitlab.com/INemo/skoltech_cardiology/-/blob/master/src/active_learning/model_wrappers.py" property="og:url">
<meta content="summary" property="twitter:card">
<meta content="src/active_learning/model_wrappers.py · master · Nemo / skoltech_cardiology" property="twitter:title">
...
<title>src/active_learning/model_wrappers.py · master · Nemo / skoltech_cardiology · GitLab</title>
...
<script nonce="Xey7fZzAJhWA3jJGEyg/xw==">
//<![CDATA[
...
<meta name="csrf-token" content="azt45eXUAoRrO0YwgmDK4/09zc1j2gkmKv5e3OvuvtaV/dCm/mRvjxRuyrbm8ZE4WvoNFUbqs80w+2zNOWLDnQ==" />
<meta name="csp-nonce" content="Xey7fZzAJhWA3jJGEyg/xw==" />
...
<li>
<h2 class="breadcrumbs-sub-title"><a href="/INemo/skoltech_cardiology/-/blob/master/src/active_learning/model_wrappers.py">Repository</a></h2>
</li>
</ul>
</div>
...
<input type="hidden" name="path" id="path" value="src/active_learning/model_wrappers.py" />
<div class="dropdown">
...
<li class="breadcrumb-item">
<a href="/INemo/skoltech_cardiology/-/blob/master/src/active_learning/model_wrappers.py"><strong>model_wrappers.py</strong>
</a></li>
</ul>
</div>
...
</a><a class="btn js-blob-blame-link" href="/INemo/skoltech_cardiology/-/blame/master/src/active_learning/model_wrappers.py">Blame</a><a class="btn" href="/INemo/skoltech_cardiology/-/commits/master/src/active_learning/model_wrappers.py">History</a><a class="btn js-data-file-blob-permalink-url" href="/INemo/skoltech_cardiology/-/blob/f4f5836b8f9143cae38b3dde81ffb550bd08a65f/src/active_learning/model_wrappers.py">Permalink</a></div>
</div>
...
<a href="/cdn-cgi/l/email-protection#7312001b161f1e121d1c053300181c1f0716101b5d0106"><img alt="Artem Shelmanov&#39;s avatar" src="https://secure.gravatar.com/avatar/fae9b6ef15fc63cf4553cd69f90a778c?s=80&amp;d=identicon" class="avatar s40 d-none d-sm-inline-block" title="Artem Shelmanov" /></a>
</div>
...
<div class="committer">
<a class="commit-author-link" href="/cdn-cgi/l/email-protection#29485a414c45444847465f695a4246455d4c4a41075b5c">Artem Shelmanov</a> authored <time class="js-timeago" title="May 26, 2020 12:33pm" datetime="2020-05-26T12:33:48Z" data-toggle="tooltip" data-placement="bottom" data-container="body">May 26, 2020</time>
</div>
...
<button class="btn btn-clipboard btn-transparent" data-toggle="tooltip" data-placement="bottom" data-container="body" data-class="btn-clipboard btn-transparent" data-title="Copy file path" data-clipboard-text="{&quot;text&quot;:&quot;src/active_learning/model_wrappers.py&quot;,&quot;gfm&quot;:&quot;`src/active_learning/model_wrappers.py`&quot;}" type="button" title="Copy file path" aria-label="Copy file path"><svg><use xlink:href="https://gitlab.com/assets/icons-90227aa2072f13fbd9d48c8c4dc56f01905607480b3fe0e9c4dd50bbf6f6cf38.svg#copy-to-clipboard"></use></svg></button>
<small class="mr-1">
6.34 KB
</small>
</div>

<div class="file-actions"><a class="btn btn-primary js-edit-blob ml-2  btn-sm" href="/INemo/skoltech_cardiology/-/edit/master/src/active_learning/model_wrappers.py">Edit</a><a class="btn btn-inverted btn-primary ide-edit-button ml-2 btn-sm" href="/-/ide/project/INemo/skoltech_cardiology/edit/master/-/src/active_learning/model_wrappers.py">Web IDE</a><div class="btn-group ml-2" role="group">
...
<button class="btn btn btn-sm js-copy-blob-source-btn" data-toggle="tooltip" data-placement="bottom" data-container="body" data-class="btn btn-sm js-copy-blob-source-btn" data-title="Copy file contents" data-clipboard-target=".blob-content[data-blob-id=&#39;19f604765deb0d6f172f5dc546c623da25287a1d&#39;]" type="button" title="Copy file contents" aria-label="Copy file contents"><svg><use xlink:href="https://gitlab.com/assets/icons-90227aa2072f13fbd9d48c8c4dc56f01905607480b3fe0e9c4dd50bbf6f6cf38.svg#copy-to-clipboard"></use></svg></button>
<a class="btn btn-sm has-tooltip" target="_blank" rel="noopener noreferrer" aria-label="Open raw" title="Open raw" data-container="body" href="/INemo/skoltech_cardiology/-/raw/master/src/active_learning/model_wrappers.py"><svg><use xlink:href="https://gitlab.com/assets/icons-90227aa2072f13fbd9d48c8c4dc56f01905607480b3fe0e9c4dd50bbf6f6cf38.svg#doc-code"></use></svg></a>
<a download="src/active_learning/model_wrappers.py" class="btn btn-sm has-tooltip" target="_blank" rel="noopener noreferrer" aria-label="Download" title="Download" data-container="body" href="/INemo/skoltech_cardiology/-/raw/master/src/active_learning/model_wrappers.py?inline=false"><svg><use xlink:href="https://gitlab.com/assets/icons-90227aa2072f13fbd9d48c8c4dc56f01905607480b3fe0e9c4dd50bbf6f6cf38.svg#download"></use></svg></a>
...
<a class="js-fork-suggestion-button btn btn-grouped btn-inverted btn-success" rel="nofollow" data-method="post" href="/INemo/skoltech_cardiology/-/blob/master/src/active_learning/model_wrappers.py">Fork</a>
...
<div class="blob-viewer" data-type="simple" data-url="/INemo/skoltech_cardiology/-/blob/master/src/active_learning/model_wrappers.py?format=json&amp;viewer=simple">
...
<h3 class="page-title">Delete model_wrappers.py</h3>
<button aria-label="Close" class="close" data-dismiss="modal" type="button">
<span aria-hidden>&times;</span>
</button>
</div>
<div class="modal-body">
<form class="js-delete-blob-form js-quick-submit js-requires-input" action="/INemo/skoltech_cardiology/-/blob/master/src/active_learning/model_wrappers.py" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="_method" value="delete" /><input type="hidden" name="authenticity_token" value="HKXLKVh9m9iAgh+kBQ9VLk6qNciXHu08tRTcEoUgpb3iY2NqQ8320//XkyJhng716W31ELIuV9evEe4DV6zY9g==" /><div class="form-group row commit_message-group">
<label class="col-form-label col-sm-2" for="commit_message-7661248e34013a8740261ecfe49acbdd">Commit message
</label><div class="col-sm-10">
<div class="commit-message-container">
<div class="max-width-marker"></div>
<textarea name="commit_message" id="commit_message-7661248e34013a8740261ecfe49acbdd" class="form-control js-commit-message" placeholder="Delete model_wrappers.py" required="required" rows="3">
Delete model_wrappers.py</textarea>
</div>
</div>
</div>
...
<input type="checkbox" name="create_merge_request" id="create_merge_request-d7a95f88941fbb62d2f7039caf4951ee" value="1" class="js-create-merge-request form-check-input" checked="checked" />
<label class="form-check-label" for="create_merge_request-d7a95f88941fbb62d2f7039caf4951ee">Start a <strong>new merge request</strong> with these changes
</label></div>
...
<div class="modal-content">
<div class="modal-header">
<h3 class="page-title">Replace model_wrappers.py</h3>
<button aria-label="Close" class="close" data-dismiss="modal" type="button">
<span aria-hidden>&times;</span>
</button>
</div>
<div class="modal-body">
<form class="js-quick-submit js-upload-blob-form" data-method="put" action="/INemo/skoltech_cardiology/-/update/master/src/active_learning/model_wrappers.py" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="_method" value="put" /><input type="hidden" name="authenticity_token" value="saUwdgUO4YuzKRzQrubQQy3iFq8HPaxml16TnU1Ni0xPY5g1Hr6MgMx8kFbKd4uYiiXWdyINFo2NW6GMn8H2Bw==" /><div class="dropzone">
...
<label class="col-form-label col-sm-2" for="commit_message-2705dfd39c87327842e0e3d0f5a5ad9c">Commit message
</label><div class="col-sm-10">
<div class="commit-message-container">
<div class="max-width-marker"></div>
<textarea name="commit_message" id="commit_message-2705dfd39c87327842e0e3d0f5a5ad9c" class="form-control js-commit-message" placeholder="Replace model_wrappers.py" required="required" rows="3">
Replace model_wrappers.py</textarea>
</div>
</div>
</div>
...
<div class="js-create-merge-request-container">
<div class="form-check gl-mt-3">
<input type="checkbox" name="create_merge_request" id="create_merge_request-05048de30add53ed7ff2d00dc762f71a" value="1" class="js-create-merge-request form-check-input" checked="checked" />
<label class="form-check-label" for="create_merge_request-05048de30add53ed7ff2d00dc762f71a">Start a <strong>new merge request</strong> with these changes
</label></div>
