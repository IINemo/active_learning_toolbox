...
<meta content="src/active_learning/libact_bert_creator.py · master · Nemo / skoltech_cardiology" property="og:title">
...
<meta content="https://gitlab.com/INemo/skoltech_cardiology/-/blob/master/src/active_learning/libact_bert_creator.py" property="og:url">
<meta content="summary" property="twitter:card">
<meta content="src/active_learning/libact_bert_creator.py · master · Nemo / skoltech_cardiology" property="twitter:title">
...
<title>src/active_learning/libact_bert_creator.py · master · Nemo / skoltech_cardiology · GitLab</title>
...
<script nonce="4JXpibZLOpY2LySv0Gt4Ag==">
//<![CDATA[
...
<meta name="csrf-token" content="XpXzDX60A2U1uUrmeIlZNz5dC9Mg9DUPOjY8rrnsJyagU1tOZQRubkrsxmAcGALsmZrLCwXEj+QgMw6/a2BabQ==" />
<meta name="csp-nonce" content="4JXpibZLOpY2LySv0Gt4Ag==" />
...
<body class="ui-indigo tab-width-8  gl-browser-chrome gl-platform-windows" data-find-file="/INemo/skoltech_cardiology/-/find_file/master" data-namespace-id="3159017" data-page="projects:blob:show" data-page-type-id="master/src/active_learning/libact_bert_creator.py" data-project="skoltech_cardiology" data-project-id="10094302">
...
<li>
<h2 class="breadcrumbs-sub-title"><a href="/INemo/skoltech_cardiology/-/blob/master/src/active_learning/libact_bert_creator.py">Repository</a></h2>
</li>
</ul>
</div>
...
<div class="js-signature-container" data-signatures-path="/INemo/skoltech_cardiology/-/commits/07eef965a5b628982613fe957e179519f90c8d43/signatures?limit=1"></div>
...
<input type="hidden" name="path" id="path" value="src/active_learning/libact_bert_creator.py" />
<div class="dropdown">
...
<li class="breadcrumb-item">
<a href="/INemo/skoltech_cardiology/-/blob/master/src/active_learning/libact_bert_creator.py"><strong>libact_bert_creator.py</strong>
</a></li>
</ul>
</div>
...
</a><a class="btn js-blob-blame-link" href="/INemo/skoltech_cardiology/-/blame/master/src/active_learning/libact_bert_creator.py">Blame</a><a class="btn" href="/INemo/skoltech_cardiology/-/commits/master/src/active_learning/libact_bert_creator.py">History</a><a class="btn js-data-file-blob-permalink-url" href="/INemo/skoltech_cardiology/-/blob/f4f5836b8f9143cae38b3dde81ffb550bd08a65f/src/active_learning/libact_bert_creator.py">Permalink</a></div>
</div>

<div class="info-well d-none d-sm-block">
<div class="well-segment">
<ul class="blob-commit-info">
<li class="commit flex-row js-toggle-container" id="commit-07eef965">
<div class="avatar-cell d-none d-sm-block">
<a href="/cdn-cgi/l/email-protection#ceafbda6aba2a3afa0a1b88ebda5a1a2baabada6e0bcbb"><img alt="Artem Shelmanov&#39;s avatar" src="https://secure.gravatar.com/avatar/fae9b6ef15fc63cf4553cd69f90a778c?s=80&amp;d=identicon" class="avatar s40 d-none d-sm-inline-block" title="Artem Shelmanov" /></a>
</div>
<div class="commit-detail flex-list">
<div class="commit-content qa-commit-content">
<a class="commit-row-message item-title js-onboarding-commit-item " href="/INemo/skoltech_cardiology/-/commit/07eef965a5b628982613fe957e179519f90c8d43">Simplified notebooks for al</a>
<span class="commit-row-message d-inline d-sm-none">
&middot;
07eef965
</span>
<div class="committer">
<a class="commit-author-link" href="/cdn-cgi/l/email-protection#dabba9b2bfb6b7bbb4b5ac9aa9b1b5b6aebfb9b2f4a8af">Artem Shelmanov</a> authored <time class="js-timeago" title="May 26, 2020 12:33pm" datetime="2020-05-26T12:33:48Z" data-toggle="tooltip" data-placement="bottom" data-container="body">May 26, 2020</time>
</div>

</div>
<div class="commit-actions flex-row">

<div class="js-commit-pipeline-status" data-endpoint="/INemo/skoltech_cardiology/-/commit/07eef965a5b628982613fe957e179519f90c8d43/pipelines?ref=master"></div>
<div class="commit-sha-group d-none d-sm-flex">
<div class="label label-monospace monospace">
07eef965
</div>
<button class="btn btn btn-default" data-toggle="tooltip" data-placement="bottom" data-container="body" data-title="Copy commit SHA" data-class="btn btn-default" data-clipboard-text="07eef965a5b628982613fe957e179519f90c8d43" type="button" title="Copy commit SHA" aria-label="Copy commit SHA"><svg><use xlink:href="https://gitlab.com/assets/icons-90227aa2072f13fbd9d48c8c4dc56f01905607480b3fe0e9c4dd50bbf6f6cf38.svg#copy-to-clipboard"></use></svg></button>
...
libact_bert_creator.py
</strong>
<button class="btn btn-clipboard btn-transparent" data-toggle="tooltip" data-placement="bottom" data-container="body" data-class="btn-clipboard btn-transparent" data-title="Copy file path" data-clipboard-text="{&quot;text&quot;:&quot;src/active_learning/libact_bert_creator.py&quot;,&quot;gfm&quot;:&quot;`src/active_learning/libact_bert_creator.py`&quot;}" type="button" title="Copy file path" aria-label="Copy file path"><svg><use xlink:href="https://gitlab.com/assets/icons-90227aa2072f13fbd9d48c8c4dc56f01905607480b3fe0e9c4dd50bbf6f6cf38.svg#copy-to-clipboard"></use></svg></button>
<small class="mr-1">
3.65 KB
</small>
</div>

<div class="file-actions"><a class="btn btn-primary js-edit-blob ml-2  btn-sm" href="/INemo/skoltech_cardiology/-/edit/master/src/active_learning/libact_bert_creator.py">Edit</a><a class="btn btn-inverted btn-primary ide-edit-button ml-2 btn-sm" href="/-/ide/project/INemo/skoltech_cardiology/edit/master/-/src/active_learning/libact_bert_creator.py">Web IDE</a><div class="btn-group ml-2" role="group">
...
<button class="btn btn btn-sm js-copy-blob-source-btn" data-toggle="tooltip" data-placement="bottom" data-container="body" data-class="btn btn-sm js-copy-blob-source-btn" data-title="Copy file contents" data-clipboard-target=".blob-content[data-blob-id=&#39;f034fe3f44f8bb7caa06727cac0dd0587cc3b6ab&#39;]" type="button" title="Copy file contents" aria-label="Copy file contents"><svg><use xlink:href="https://gitlab.com/assets/icons-90227aa2072f13fbd9d48c8c4dc56f01905607480b3fe0e9c4dd50bbf6f6cf38.svg#copy-to-clipboard"></use></svg></button>
<a class="btn btn-sm has-tooltip" target="_blank" rel="noopener noreferrer" aria-label="Open raw" title="Open raw" data-container="body" href="/INemo/skoltech_cardiology/-/raw/master/src/active_learning/libact_bert_creator.py"><svg><use xlink:href="https://gitlab.com/assets/icons-90227aa2072f13fbd9d48c8c4dc56f01905607480b3fe0e9c4dd50bbf6f6cf38.svg#doc-code"></use></svg></a>
<a download="src/active_learning/libact_bert_creator.py" class="btn btn-sm has-tooltip" target="_blank" rel="noopener noreferrer" aria-label="Download" title="Download" data-container="body" href="/INemo/skoltech_cardiology/-/raw/master/src/active_learning/libact_bert_creator.py?inline=false"><svg><use xlink:href="https://gitlab.com/assets/icons-90227aa2072f13fbd9d48c8c4dc56f01905607480b3fe0e9c4dd50bbf6f6cf38.svg#download"></use></svg></a>
...
<a class="js-fork-suggestion-button btn btn-grouped btn-inverted btn-success" rel="nofollow" data-method="post" href="/INemo/skoltech_cardiology/-/blob/master/src/active_learning/libact_bert_creator.py">Fork</a>
...
<div class="blob-viewer" data-type="simple" data-url="/INemo/skoltech_cardiology/-/blob/master/src/active_learning/libact_bert_creator.py?format=json&amp;viewer=simple">
...
<h3 class="page-title">Delete libact_bert_creator.py</h3>
<button aria-label="Close" class="close" data-dismiss="modal" type="button">
<span aria-hidden>&times;</span>
</button>
</div>
<div class="modal-body">
<form class="js-delete-blob-form js-quick-submit js-requires-input" action="/INemo/skoltech_cardiology/-/blob/master/src/active_learning/libact_bert_creator.py" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="_method" value="delete" /><input type="hidden" name="authenticity_token" value="T/Qf9rI4oW5+IcKQ/BUpK56cVrXrqa6kmgsqmXRDmh+xMre1qYjMZQF0ThaYhHLwOVuWbc6ZFE+ADhiIps/nVA==" /><div class="form-group row commit_message-group">
<label class="col-form-label col-sm-2" for="commit_message-ef88347e73982dd09175a7f3828bf981">Commit message
</label><div class="col-sm-10">
<div class="commit-message-container">
<div class="max-width-marker"></div>
<textarea name="commit_message" id="commit_message-ef88347e73982dd09175a7f3828bf981" class="form-control js-commit-message" placeholder="Delete libact_bert_creator.py" required="required" rows="3">
Delete libact_bert_creator.py</textarea>
</div>
</div>
</div>
...
<input type="checkbox" name="create_merge_request" id="create_merge_request-3b22e891f66de1d7ca98440e959d8586" value="1" class="js-create-merge-request form-check-input" checked="checked" />
<label class="form-check-label" for="create_merge_request-3b22e891f66de1d7ca98440e959d8586">Start a <strong>new merge request</strong> with these changes
</label></div>
...
<div class="modal-content">
<div class="modal-header">
<h3 class="page-title">Replace libact_bert_creator.py</h3>
<button aria-label="Close" class="close" data-dismiss="modal" type="button">
<span aria-hidden>&times;</span>
</button>
</div>
<div class="modal-body">
<form class="js-quick-submit js-upload-blob-form" data-method="put" action="/INemo/skoltech_cardiology/-/update/master/src/active_learning/libact_bert_creator.py" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="_method" value="put" /><input type="hidden" name="authenticity_token" value="tX5rXPrfxvvi5Pv9lrK/6M8yREshdV+JN8C5hqaFr3NLuMMf4W+r8J2xd3vyI+QzaPWEkwRF5WItxYuXdAnSOA==" /><div class="dropzone">
...
<label class="col-form-label col-sm-2" for="commit_message-54aa26c7f5dcde18d4321d491f21ab1f">Commit message
</label><div class="col-sm-10">
<div class="commit-message-container">
<div class="max-width-marker"></div>
<textarea name="commit_message" id="commit_message-54aa26c7f5dcde18d4321d491f21ab1f" class="form-control js-commit-message" placeholder="Replace libact_bert_creator.py" required="required" rows="3">
Replace libact_bert_creator.py</textarea>
</div>
</div>
</div>
...
<div class="js-create-merge-request-container">
<div class="form-check gl-mt-3">
<input type="checkbox" name="create_merge_request" id="create_merge_request-47945ae1a5cec67a22c5020710f49b9e" value="1" class="js-create-merge-request form-check-input" checked="checked" />
<label class="form-check-label" for="create_merge_request-47945ae1a5cec67a22c5020710f49b9e">Start a <strong>new merge request</strong> with these changes
</label></div>
